...
class ListBottomSheetUsaha extends StatefulWidget {
  const ListBottomSheetUsaha({super.key});

  @override
  State<ListBottomSheetUsaha> createState() => _ListBottomSheetUsahaState();
}

class _ListBottomSheetUsahaState extends State<ListBottomSheetUsaha> {
  ...
  void addListItinerary2(BuildContext context) async {
    ...
    AgendaModel agendaModel = AgendaModel(
      ...
      jamMulai: '${_time.hour}:${_time.second}',
      jamSelesai: '${_time2.hour}:${_time2.second}',
