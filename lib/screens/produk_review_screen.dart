...
import 'package:intravel_ease/providers/produk_review_provider.dart';
...
class ProdukReviewScreen extends StatefulWidget {
  const ProdukReviewScreen({super.key});

  @override
  State<ProdukReviewScreen> createState() => _ProdukReviewScreenState();
}

class _ProdukReviewScreenState extends State<ProdukReviewScreen> {
  ProdukReviewProvider initProvider = ProdukReviewProvider();
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: initProvider,
      child: Consumer<ProdukReviewProvider>(
                ...
                SliverAppBar(
                  ...
                  title: Row(
                    children: [
                      ...
                      TextHelper(text: 'Rating Produk', fontSize: 18.sp)
                    ],
                  ),
                ),
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextHelper(
                                        text:
                                            "${snapshot.data![index].ratingpd_komentar}",
                                        fontSize: 12.sp),
                                  ),
                                ),
                              ]),
